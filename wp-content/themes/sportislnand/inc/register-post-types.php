...
function _register_types(){
    ...
    register_post_type( 'houses', [
        'labels' => [
            'name'               => __('Объекты недвижимости', 'sport-island'), // основное название для типа записи
            ...
            'menu_name'          => __('Объекты недвижимости', 'sport-island'), // название меню
            // WP открывает файл перевода и ищетв нем эту строку 'Объекты недвижимости'
            // __ - функция возвращает переведенную строку
        ],
        'public'              => true,
        'menu_position'       => 20,
