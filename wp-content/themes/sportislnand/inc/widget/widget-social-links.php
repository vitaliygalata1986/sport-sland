...
class SI_Widget_Social_Links extends WP_Widget{
   ...
   private $socials = [ // приватное, так как должно быть внутри только нашего класса
        'fb' =>[
            'Facebook',
            '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	            viewBox="0 0 155.139 155.139" style="enable-background:new 0 0 155.139 155.139;" xml:space="preserve">
	            <style>path{fill: #fff;}</style><g><path d="M89.584,155.139V84.378h23.742l3.562-27.585H89.584V39.184
		        c0-7.984,2.208-13.425,13.67-13.425l14.595-0.006V1.08C115.325,0.752,106.661,0,96.577,0C75.52,0,61.104,12.853,61.104,36.452
		        v20.341H37.29v27.585h23.814v70.761H89.584z"/></g></svg>
            '
        ],
        'vk' =>[
            'Вконтакте',
            '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	            ...
	            xml:space="preserve"><style>path{fill: #fff;}</style><g><path d="M545.451,400.298c-0.664-1.431-1.283-2.618-1.858-3.569c-9.514-17.135-27.695-38.167-54.532-63.102l-0.567-0.571
        ...
        'instagram' =>[
            ...
            '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                xml:space="preserve">
                <style>path{fill: #fff;}</style><g><path d="M12.501,0h72.393c6.875,0,12.5,5.09,12.5,12.5v72.395c0,7.41-5.625,12.5-12.5,12.5H12.501C5.624,97.395,0,92.305,0,84.895
                V12.5C0,5.09,5.624,0,12.501,0L12.501,0z M70.948,10.821c-2.412,0-4.383,1.972-4.383,4.385v10.495c0,2.412,1.971,4.385,4.383,4.385
                h11.008c2.412,0,4.385-1.973,4.385-4.385V15.206c0-2.413-1.973-4.385-4.385-4.385H70.948L70.948,10.821z M86.387,41.188h-8.572
                c0.811,2.648,1.25,5.453,1.25,8.355c0,16.2-13.556,29.332-30.275,29.332c-16.718,0-30.272-13.132-30.272-29.332
                c0-2.904,0.438-5.708,1.25-8.355h-8.945v41.141c0,2.129,1.742,3.872,3.872,3.872h67.822c2.13,0,3.872-1.742,3.872-3.872V41.188
                H86.387z M48.789,29.533c-10.802,0-19.56,8.485-19.56,18.953c0,10.468,8.758,18.953,19.56,18.953
                c10.803,0,19.562-8.485,19.562-18.953C68.351,38.018,59.593,29.533,48.789,29.533z"/></g></svg>
            '
         ],
   ];
...
<p>
    ...
    <input
        ...
        value="<?php echo $instance['link'] // по ключу text, который мы указали в name - выведим данные ?>"
        id="<?php echo $this->get_field_id('id-link'); // функция возвращает уникальный id, через this можем получать методы родит. класса ?>"
    >
</p><p>
        ...
        >
            <?php foreach ($this->socials as $slug => $desc):?>
                <option
                    value="<?php echo $slug;?>"
                    <?php selected($instance['slug'],$slug, true); // 1-тот вариант, который уже выбран (slug - select name=slug) - т.е. достаем из базы, 2-й, тот option, которы й сейчас распечатывается. Функция selected сравнивает, какой раньше вариант был выбран и записан в базу $instance['slug'], с тем вариантом, который сейчас выводится $slug - и если они совпадают, то функция вернет нам строку checked
