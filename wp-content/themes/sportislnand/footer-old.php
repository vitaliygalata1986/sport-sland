...
<!--          </a>-->
          ...
          <?php
            ...
            //echo '<pre>';
            //print_r( $locations); // вернет нам массив, ключи которого совпадают со слагом (ярлыком) менюшки - лежит id той записи, которая прикреплена к этой зоне
            //echo '</pre>';
          ...
          <nav class="main-navigation">
            <ul class="main-navigation__list">
                <?php
                    ...
                    $class_text = '';
                    if($menu_item->url === $url){ // если адрес пункта меню совпадает с адресом текущей страницы
