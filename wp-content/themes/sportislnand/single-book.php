...
echo '<h3>Single template from theme </h3>';
?>
    <main class="main-content">
        ...
        <?php if (have_posts()): while (have_posts()): the_post(); ?>
            <article class="main-article wrapper">
                <?php
                // Получаем значения метаполей внутри цикла поста или в шаблоне

                $book_pages = get_post_meta(get_the_ID(), 'book_pages', true); // Получаем количество страниц
                $book_cover = get_post_meta(get_the_ID(), 'book_cover', true); // Получаем наличие обложки

                // Проверяем наличие значений и выводим на фронт
                if ($book_pages) {
                    echo '<p>' . __('Number of pages:', 'sportisland') . ' ' . esc_html($book_pages) . '</p>';
                }

                if ($book_cover === 'yes') {
                    echo '<p>' . __('This book has a cover.', 'sportisland') . '</p>';
                } else {
                    echo '<p>' . __('This book does not have a cover.', 'sportisland') . '</p>';
                }
                ?>
                ...
                <header class="main-article__header">
                    ...
                    if ($custom_thumb) {
                        ...
                        <!--                        <img-->
                        <!--                                srcset="-->
                        <!--                                    --><?php //echo $custom_thumb['sizes']['si_pic']
                        ?><!-- 600w,-->
                        <!--                                    --><?php //echo $custom_thumb['sizes']['si_pic']
                        ?><!-- 480w,-->
                        <!--                                    --><?php //echo $custom_thumb['sizes']['si_pic']
                        ...
                        <!--                    <img-->
                        <!--                            srcset="--><?php //echo $custom_thumb['sizes']['si_pic']
                        ?><!-- 600w"-->
