                      ...
                      <ul class="schedule tabs-content__list">
                        <?php
                            ...
                            $actions = new WP_Query([
                                ...
                                // array( 'schedule_days' => $day->name ),

                                //'schedule_days' => $day->slug, // возьмем именно те записи у которой таксономия schedule_days была установлена в положении $day->slug - т.е.
                        ...
                        <?php while ($actions->have_posts() ): $actions->the_post(); ?>
                            <li class="schedule__item">
                              ...
                              <!--нужно получить значение термина таксономии зал для текущий записи-->
                                <!--get_the_terms говрит о том, что мы хотим получить термины какой-то конкретной записи,а не все термины-->
                                ...
                                <p class="schedule__place"
                                    style="color: <?php echo get_field('place_color', 'places_' . get_the_terms($id, 'places')[0]->term_id)?>"> <!--'places_11'-->
								<?php
                                 ...
                                 //    echo '</pre>';
                                    ...
                                    // вернется массив, возьмем только первый самый элемент?>
                                </p>
                            </li>
