<?php get_header() ?>
    <h3>Category template from plugin </h3>
        ...
        <div class="wrapper">
            ...
            <section class="prices">
                ...
                <?php if (have_posts()): while (have_posts()): the_post(); ?>
                    <?php if (!get_field('prices_show')) { // если поле не отмечено галочкой, то дальше нужно перейти на след. итерацию цикла
                        continue; // данный оператор пропустит итерацию и пойдет на следующую
                    }
                    the_content();
                endwhile;
