...
Description: Плагин делает заголовки постов полностью строчными буквами, но только на страницах отдельных постов
Version: 1.0
...
define('SPORTISLAND_DIR', plugin_dir_path(__FILE__)); // константа - путь к папке с плагином - абосолютный физический путь - без http, от корня диска до корневой папки плагина
...
require_once SPORTISLAND_DIR . 'class-sportisland-study.php';
